    ...
    backdrop-blur-sm'>
        ...
        animate={{ opacity: 1, scale: 1 }}>
            ...
            mt-4'>
                ...
                <a href={links(i).href} className='inline-flex items-center justify-center gap-1
                ...
                class="lucide lucide-square-arrow-out-up-right-icon lucide-square-arrow-out-up-right" href={links(i).href}>
